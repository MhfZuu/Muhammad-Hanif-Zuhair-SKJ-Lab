...
00401460 <_main>:
  ...
  40148e:	c7 44 24 04 65 50 40 	movl   $0x405065,0x4(%esp)
  401495:	00 
  401496:	c7                   	.byte 0xc7
  401497:	04 24                	add    $0x24,%al

00401499 <__fu0___ZSt4cout>:
  401499:	68 82 40 00 e8       	push   $0xe8004082
  40149e:	8e 00                	mov    (%eax),%es
  4014a0:	00 00                	add    %al,(%eax)
  4014a2:	89 c2                	mov    %eax,%edx
  4014a4:	8b 45 ec             	mov    -0x14(%ebp),%eax
  4014a7:	89 04 24             	mov    %eax,(%esp)
  4014aa:	89 d1                	mov    %edx,%ecx
  4014ac:	e8 9f 00 00 00       	call   401550 <__ZNSolsEi>
  4014b1:	83 ec 04             	sub    $0x4,%esp
  4014b4:	c7 04 24 38 15 40 00 	movl   $0x401538,(%esp)
  4014bb:	89 c1                	mov    %eax,%ecx
  4014bd:	e8 96 00 00 00       	call   401558 <__ZNSolsEPFRSoS_E>
  4014c2:	83 ec 04             	sub    $0x4,%esp
  4014c5:	b8 00 00 00 00       	mov    $0x0,%eax
  4014ca:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  4014cd:	c9                   	leave  
  4014ce:	8d 61 fc             	lea    -0x4(%ecx),%esp
  4014d1:	c3                   	ret    

004014d2 <___tcf_0>:
  4014d2:	55                   	push   %ebp
  4014d3:	89 e5                	mov    %esp,%ebp
  4014d5:	83 ec 08             	sub    $0x8,%esp
  4014d8:	b9 20 70 40 00       	mov    $0x407020,%ecx
  4014dd:	e8 5e 00 00 00       	call   401540 <__ZNSt8ios_base4InitD1Ev>
  4014e2:	c9                   	leave  
  4014e3:	c3                   	ret    

004014e4 <__Z41__static_initialization_and_destruction_0ii>:
  4014e4:	55                   	push   %ebp
  4014e5:	89 e5                	mov    %esp,%ebp
  4014e7:	83 ec 18             	sub    $0x18,%esp
  4014ea:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  4014ee:	75 1f                	jne    40150f <__Z41__static_initialization_and_destruction_0ii+0x2b>
  4014f0:	81 7d 0c ff ff 00 00 	cmpl   $0xffff,0xc(%ebp)
  4014f7:	75 16                	jne    40150f <__Z41__static_initialization_and_destruction_0ii+0x2b>
  4014f9:	b9 20 70 40 00       	mov    $0x407020,%ecx
  4014fe:	e8 45 00 00 00       	call   401548 <__ZNSt8ios_base4InitC1Ev>
  401503:	c7 04 24 d2 14 40 00 	movl   $0x4014d2,(%esp)
  40150a:	e8 11 fe ff ff       	call   401320 <_atexit>
  40150f:	90                   	nop
  401510:	c9                   	leave  
  401511:	c3                   	ret    

00401512 <__GLOBAL__sub_I_main>:
  401512:	55                   	push   %ebp
  401513:	89 e5                	mov    %esp,%ebp
  401515:	83 ec 18             	sub    $0x18,%esp
  401518:	c7 44 24 04 ff ff 00 	movl   $0xffff,0x4(%esp)
  40151f:	00 
  401520:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  401527:	e8 b8 ff ff ff       	call   4014e4 <__Z41__static_initialization_and_destruction_0ii>
  40152c:	c9                   	leave  
  40152d:	c3                   	ret    
  40152e:	90                   	nop
  40152f:	90                   	nop
...
00401dd0 <.text>:
  ...
  401dee:	c7 04 24 74 50 40 00 	movl   $0x405074,(%esp)
  ...
  401f03:	00 
  401f04:	c7 04 24 8c 50 40 00 	movl   $0x40508c,(%esp)
...
00401f10 <__pei386_runtime_relocator>:
  ...
  401f20:	b8 f8 52 40 00       	mov    $0x4052f8,%eax
  401f25:	c7 05 60 70 40 00 01 	movl   $0x1,0x407060
  401f2c:	00 00 00 
  401f2f:	2d e0 52 40 00       	sub    $0x4052e0,%eax
  ...
  401f8b:	81 fb f8 52 40 00    	cmp    $0x4052f8,%ebx
  ...
  401fd1:	c7 04 24 f4 50 40 00 	movl   $0x4050f4,(%esp)
  401fd8:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  401fdf:	00 
  401fe0:	e8 eb fd ff ff       	call   401dd0 <.text>
  401fe5:	bb e0 52 40 00       	mov    $0x4052e0,%ebx
  401fea:	81 fb f8 52 40 00    	cmp    $0x4052f8,%ebx
  ...
  402018:	81 fb f8 52 40 00    	cmp    $0x4052f8,%ebx
  ...
  402030:	bb e0 52 40 00       	mov    $0x4052e0,%ebx
  ...
  4020cf:	c7 04 24 c0 50 40 00 	movl   $0x4050c0,(%esp)
...
00402190 <.text>:
  ...
  4028e9:	bf 20 51 40 00       	mov    $0x405120,%edi
...
004031b0 <___mingw_globfree>:
  ...
  4031ba:	81 3e 22 51 40 00    	cmpl   $0x405122,(%esi)
...
00403210 <___mingw_dirname>:
  ...
  40323d:	c7 44 24 04 34 51 40 	movl   $0x405134,0x4(%esp)
  403244:	00 
  ...
  403267:	00 
  403268:	c7 44 24 04 36 51 40 	movl   $0x405136,0x4(%esp)
  40326f:	00 
  ...
  403299:	c7 44 24 04 36 51 40 	movl   $0x405136,0x4(%esp)
  4032a0:	00 
